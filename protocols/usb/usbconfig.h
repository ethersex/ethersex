...
#define USB_CFG_IOPORTNAME      USB_DMINUS_PORT
/* This is the port where the USB bus is connected. When you configure it to
 * "B", the registers PORTB, PINB and DDRB will be used.
 */
#define USB_CFG_DMINUS_BIT      USB_DMINUS_PIN
/* This is the bit number in USB_CFG_IOPORT where the USB D- line is connected.
 * This may be any bit in the port.
 */
#define USB_CFG_DPLUS_BIT       USB_DPLUS_PIN
/* This is the bit number in USB_CFG_IOPORT where the USB D+ line is connected.
 ...
 */
#define  USB_CFG_DEVICE_ID       0xdc, 0x05 /* no usb device class */
 ...
 */
#define USB_CFG_VENDOR_NAME     'z', 'e', 'r', 't', 'i', 'e', 's', '.', 'o', 'r', 'g'
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'e', 't', 'h', 'e', 'r', 's', 'e', 'x'
