...
ecmd_ifdef(STELLA_SUPPORT)
  ...
  ecmd_feature(stella_version, "stella version",, Get stella protocol version)
  ...
  ecmd_feature(stella_channel_set, "channel set", CHANNEL VALUE,Set stella channel to value. You may use fade channel constants.)
