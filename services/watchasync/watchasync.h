...
#ifndef CONF_WATCHASYNC_PE
#define CONF_WATCHASYNC_PE
#endif
#define WATCHASYNC_PE0 1
#else
#define WATCHASYNC_PE0 0
#endif
...
#define CONF_WATCHASYNC_PE
#endif
#define WATCHASYNC_PE1 1
#else
#define WATCHASYNC_PE1 0
#endif
...
#define CONF_WATCHASYNC_PE
#endif
#define WATCHASYNC_PE2 1
#else
#define WATCHASYNC_PE2 0
#endif
...
#define CONF_WATCHASYNC_PE
#endif
#define WATCHASYNC_PE3 1
#else
#define WATCHASYNC_PE3 0
#endif
...
#define CONF_WATCHASYNC_PE
#endif
#define WATCHASYNC_PE4 1
#else
#define WATCHASYNC_PE4 0
#endif
...
#define CONF_WATCHASYNC_PE
#endif
#define WATCHASYNC_PE5 1
#else
#define WATCHASYNC_PE5 0
#endif
...
#define CONF_WATCHASYNC_PE
#endif
#define WATCHASYNC_PE6 1
#else
#define WATCHASYNC_PE6 0
#endif
...
#define CONF_WATCHASYNC_PE
#endif
#define WATCHASYNC_PE7 1
#else
#define WATCHASYNC_PE7 0
#endif


#ifdef CONF_WATCHASYNC_PF0
#ifndef CONF_WATCHASYNC_PF
#define CONF_WATCHASYNC_PF
#endif
#define WATCHASYNC_PF0 1
#else
#define WATCHASYNC_PF0 0
#endif
...
#define CONF_WATCHASYNC_PF
#endif
#define WATCHASYNC_PF1 1
#else
#define WATCHASYNC_PF1 0
#endif
...
#define CONF_WATCHASYNC_PF
#endif
#define WATCHASYNC_PF2 1
#else
#define WATCHASYNC_PF2 0
#endif
...
#define CONF_WATCHASYNC_PF
#endif
#define WATCHASYNC_PF3 1
#else
#define WATCHASYNC_PF3 0
#endif
...
#define CONF_WATCHASYNC_PF
#endif
#define WATCHASYNC_PF4 1
#else
#define WATCHASYNC_PF4 0
#endif
...
#define CONF_WATCHASYNC_PF
#endif
#define WATCHASYNC_PF5 1
#else
#define WATCHASYNC_PF5 0
#endif
...
#define CONF_WATCHASYNC_PF
#endif
#define WATCHASYNC_PF6 1
#else
#define WATCHASYNC_PF6 0
#endif
...
#define CONF_WATCHASYNC_PF
#endif
#define WATCHASYNC_PF7 1
#else
#define WATCHASYNC_PF7 0
#endif


#ifdef CONF_WATCHASYNC_PG0
#ifndef CONF_WATCHASYNC_PG
#define CONF_WATCHASYNC_PG
#endif
#define WATCHASYNC_PG0 1
#else
#define WATCHASYNC_PG0 0
#endif
...
#define CONF_WATCHASYNC_PG
#endif
#define WATCHASYNC_PG1 1
#else
#define WATCHASYNC_PG1 0
#endif
...
#define CONF_WATCHASYNC_PG
#endif
#define WATCHASYNC_PG2 1
#else
#define WATCHASYNC_PG2 0
#endif
...
#define CONF_WATCHASYNC_PG
#endif
#define WATCHASYNC_PG3 1
#else
#define WATCHASYNC_PG3 0
#endif
...
#define CONF_WATCHASYNC_PG
#endif
#define WATCHASYNC_PG4 1
#else
#define WATCHASYNC_PG4 0
#endif
...
#define WATCHASYNC_PE0_INDEX (WATCHASYNC_PD7_INDEX + WATCHASYNC_PD7)
#define WATCHASYNC_PE1_INDEX (WATCHASYNC_PE0_INDEX + WATCHASYNC_PE0)
#define WATCHASYNC_PE2_INDEX (WATCHASYNC_PE1_INDEX + WATCHASYNC_PE1)
#define WATCHASYNC_PE3_INDEX (WATCHASYNC_PE2_INDEX + WATCHASYNC_PE2)
#define WATCHASYNC_PE4_INDEX (WATCHASYNC_PE3_INDEX + WATCHASYNC_PE3)
#define WATCHASYNC_PE5_INDEX (WATCHASYNC_PE4_INDEX + WATCHASYNC_PE4)
#define WATCHASYNC_PE6_INDEX (WATCHASYNC_PE5_INDEX + WATCHASYNC_PE5)
#define WATCHASYNC_PE7_INDEX (WATCHASYNC_PE6_INDEX + WATCHASYNC_PE6)

#define WATCHASYNC_PF0_INDEX (WATCHASYNC_PE7_INDEX + WATCHASYNC_PE7)
#define WATCHASYNC_PF1_INDEX (WATCHASYNC_PF0_INDEX + WATCHASYNC_PF0)
#define WATCHASYNC_PF2_INDEX (WATCHASYNC_PF1_INDEX + WATCHASYNC_PF1)
#define WATCHASYNC_PF3_INDEX (WATCHASYNC_PF2_INDEX + WATCHASYNC_PF2)
#define WATCHASYNC_PF4_INDEX (WATCHASYNC_PF3_INDEX + WATCHASYNC_PF3)
#define WATCHASYNC_PF5_INDEX (WATCHASYNC_PF4_INDEX + WATCHASYNC_PF4)
#define WATCHASYNC_PF6_INDEX (WATCHASYNC_PF5_INDEX + WATCHASYNC_PF5)
#define WATCHASYNC_PF7_INDEX (WATCHASYNC_PF6_INDEX + WATCHASYNC_PF6)

#define WATCHASYNC_PG0_INDEX (WATCHASYNC_PF7_INDEX + WATCHASYNC_PF7)
#define WATCHASYNC_PG1_INDEX (WATCHASYNC_PG0_INDEX + WATCHASYNC_PG0)
#define WATCHASYNC_PG2_INDEX (WATCHASYNC_PG1_INDEX + WATCHASYNC_PG1)
#define WATCHASYNC_PG3_INDEX (WATCHASYNC_PG2_INDEX + WATCHASYNC_PG2)
#define WATCHASYNC_PG4_INDEX (WATCHASYNC_PG3_INDEX + WATCHASYNC_PG3)

#define WATCHASYNC_PA_MASK ( WATCHASYNC_PA0 *  1 + WATCHASYNC_PA1 *   2 + \
       WATCHASYNC_PA2 *  4 + WATCHASYNC_PA3 *  8 + WATCHASYNC_PA4 *  16 + \
       WATCHASYNC_PA5 * 32 + WATCHASYNC_PA6 * 64 + WATCHASYNC_PA7 * 128)
#define WATCHASYNC_PB_MASK ( WATCHASYNC_PB0 *  1 + WATCHASYNC_PB1 *   2 + \
       WATCHASYNC_PB2 *  4 + WATCHASYNC_PB3 *  8 + WATCHASYNC_PB4 *  16 + \
       WATCHASYNC_PB5 * 32 + WATCHASYNC_PB6 * 64 + WATCHASYNC_PB7 * 128)
#define WATCHASYNC_PC_MASK ( WATCHASYNC_PC0 *  1 + WATCHASYNC_PC1 *   2 + \
       WATCHASYNC_PC2 *  4 + WATCHASYNC_PC3 *  8 + WATCHASYNC_PC4 *  16 + \
       WATCHASYNC_PC5 * 32 + WATCHASYNC_PC6 * 64 + WATCHASYNC_PC7 * 128)
#define WATCHASYNC_PD_MASK ( WATCHASYNC_PD0 *  1 + WATCHASYNC_PD1 *   2 + \
       WATCHASYNC_PD2 *  4 + WATCHASYNC_PD3 *  8 + WATCHASYNC_PD4 *  16 + \
       WATCHASYNC_PD5 * 32 + WATCHASYNC_PD6 * 64 + WATCHASYNC_PD7 * 128)
#define WATCHASYNC_PE_MASK ( WATCHASYNC_PE0 *  1 + WATCHASYNC_PE1 *   2 + \
       WATCHASYNC_PE2 *  4 + WATCHASYNC_PE3 *  8 + WATCHASYNC_PE4 *  16 + \
       WATCHASYNC_PE5 * 32 + WATCHASYNC_PE6 * 64 + WATCHASYNC_PE7 * 128)
#define WATCHASYNC_PF_MASK ( WATCHASYNC_PF0 *  1 + WATCHASYNC_PF1 *   2 + \
       WATCHASYNC_PF2 *  4 + WATCHASYNC_PF3 *  8 + WATCHASYNC_PF4 *  16 + \
       WATCHASYNC_PF5 * 32 + WATCHASYNC_PF6 * 64 + WATCHASYNC_PF7 * 128)
#define WATCHASYNC_PG_MASK ( WATCHASYNC_PG0 *  1 + WATCHASYNC_PG1 *   2 + \
       WATCHASYNC_PG2 *  4 + WATCHASYNC_PG3 *  8 + WATCHASYNC_PG4 *  16)

#define WATCHASYNC_PINCOUNT ( \
    WATCHASYNC_PA0 + WATCHASYNC_PA1 + WATCHASYNC_PA2 + WATCHASYNC_PA3 + \
    WATCHASYNC_PA4 + WATCHASYNC_PA5 + WATCHASYNC_PA6 + WATCHASYNC_PA7 + \
    WATCHASYNC_PB0 + WATCHASYNC_PB1 + WATCHASYNC_PB2 + WATCHASYNC_PB3 + \
    WATCHASYNC_PB4 + WATCHASYNC_PB5 + WATCHASYNC_PB6 + WATCHASYNC_PB7 + \
    WATCHASYNC_PC0 + WATCHASYNC_PC1 + WATCHASYNC_PC2 + WATCHASYNC_PC3 + \
    WATCHASYNC_PC4 + WATCHASYNC_PC5 + WATCHASYNC_PC6 + WATCHASYNC_PC7 + \
    WATCHASYNC_PD0 + WATCHASYNC_PD1 + WATCHASYNC_PD2 + WATCHASYNC_PD3 + \
    WATCHASYNC_PD4 + WATCHASYNC_PD5 + WATCHASYNC_PD6 + WATCHASYNC_PD7 + \
    WATCHASYNC_PE0 + WATCHASYNC_PE1 + WATCHASYNC_PE2 + WATCHASYNC_PE3 + \
    WATCHASYNC_PE4 + WATCHASYNC_PE5 + WATCHASYNC_PE6 + WATCHASYNC_PE7 + \
    WATCHASYNC_PF0 + WATCHASYNC_PF1 + WATCHASYNC_PF2 + WATCHASYNC_PF3 + \
    WATCHASYNC_PF4 + WATCHASYNC_PF5 + WATCHASYNC_PF6 + WATCHASYNC_PF7 + \
    WATCHASYNC_PG0 + WATCHASYNC_PG1 + WATCHASYNC_PG2 + WATCHASYNC_PG3 + \
    WATCHASYNC_PG4)
