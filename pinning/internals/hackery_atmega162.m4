...
#define TC1_PRESCALER_1      {TCCR1&=~(_BV(CS12)|_BV(CS11));TCCR1|=_BV(CS10);}
#define TC1_PRESCALER_8      {TCCR1&=~(_BV(CS12)|_BV(CS10));TCCR1|=_BV(CS11);}
#define TC1_PRESCALER_64     {TCCR1&=~(_BV(CS12));TCCR1|=_BV(CS11)|_BV(CS12);}
#define TC1_PRESCALER_256    {TCCR1&=~(_BV(CS11)|_BV(CS10));TCCR1|=_BV(CS12);}
#define TC1_PRESCALER_1024   {TCCR1&=~(_BV(CS11));TCCR1|=_BV(CS12)|_BV(CS10);}

#define TC1_MODE_OFF	     {TCCR1&=~(_BV(WGM11)|_BV(WGM10));TCCR1&=~(_BV(WGM12));}
#define TC1_MODE_PWM         {TCCR1&=~(_BV(WGM11));TCCR1|=_BV(WGM10);TCCR1&=~(_BV(WGM12));}
#define TC1_MODE_CTC         {TCCR1&=~(_BV(WGM10));TCCR1|=_BV(WGM11);TCCR1&=~(_BV(WGM12));}
#define TC1_MODE_PWMFAST     {TCCR1|=_BV(WGM11)|_BV(WGM10);TCCR1&=~(_BV(WGM12));}
