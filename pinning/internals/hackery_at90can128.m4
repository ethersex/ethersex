...
#define TC0_PRESCALER_64     {TCCR0A&=~(_BV(CS02));TCCR0A|=_BV(CS01)|_BV(CS00);}
...
#define TC2_PRESCALER_32     {TCCR2A&=~(_BV(CS22));TCCR2A|=_BV(CS21)|_BV(CS20);}
...
#define TC3_MODE_OFF         {TCCR3A&=~(_BV(WGM31)|_BV(WGM30));TCCR3B&=~(_BV(WGM32));}
#define TC3_MODE_PWM         {TCCR3A&=~(_BV(WGM31));TCCR3A|=_BV(WGM30);TCCR3B&=~(_BV(WGM32));}
#define TC3_MODE_CTC         {TCCR3A&=~(_BV(WGM30));TCCR3A|=_BV(WGM31);TCCR3B&=~(_BV(WGM32));}
#define TC3_MODE_PWMFAST     {TCCR3A|=_BV(WGM31)|_BV(WGM30);TCCR3B&=~(_BV(WGM32));}
...
#define TC3_COUNTER_CURRENT  TCNT1
#define TC3_COUNTER_COMPARE  OCR1A

#define TC3_INT_COMPARE_ON   TIMSK1|=_BV(OCIE1A);
#define TC3_INT_COMPARE_OFF  TIMSK1&=~_BV(OCIE1A);
#define TC3_INT_OVERFLOW_ON  TIMSK1|=_BV(TOIE1);
#define TC3_INT_OVERFLOW_OFF TIMSK1&=~_BV(TOIE1);

#define TC3_INT_OVERFLOW_TST (TIFR1&_BV(TOV1))
#define TC3_INT_OVERFLOW_CLR TIFR1=_BV(TOV1);

#define TC3_VECTOR_OVERFLOW  TIMER1_OVF_vect
#define TC3_VECTOR_COMPARE   TIMER1_COMPA_vect
