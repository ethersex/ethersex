...
#define TIMER_8_AS_1_AS_ON  {ASSR |= _BV(AS0);}
#define TIMER_8_AS_1_AS_OFF  {ASSR &=~(_BV(AS0));}
/* Prescaler */
...
/* Busy flags */
#define TIMER_8_AS_1_COUNTER_CURRENT_BUSY TCR0UB
#define TIMER_8_AS_1_COUNTER_COMPARE_BUSY TCN0UB
