...
/* Busy flags */
#define TIMER_8_AS_1_COUNTER_CURRENT_BUSY TCR2BUB
#define TIMER_8_AS_1_COUNTER_COMPARE_BUSY TCN2UB
#define TIMER_8_AS_1_COUNTER_CURRENT_BUSY_TST (ASSR&_BV(TIMER_8_AS_1_COUNTER_CURRENT_BUSY))
#define TIMER_8_AS_1_COUNTER_COMPARE_BUSY_TST (ASSR&_BV(TIMER_8_AS_1_COUNTER_COMPARE_BUSY))
/* both tests combined */
#define TIMER_8_AS_1_COUNTER_BUSY_TST (TIMER_8_AS_1_COUNTER_COMPARE_BUSY_TST || TIMER_8_AS_1_COUNTER_CURRENT_BUSY_TST)
