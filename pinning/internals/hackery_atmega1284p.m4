...
#define TC3_OUTPUT_COMPARE_NONE   {TCCR3A&=~(_BV(COM1A1)|_BV(COM1A0));}
#define TC3_OUTPUT_COMPARE_TOGGLE {TCCR3A&=~(_BV(COM1A1));TCCR3A|=_BV(COM1A0);}
#define TC3_OUTPUT_COMPARE_CLEAR  {TCCR3A&=~(_BV(COM1A0));TCCR3A|=_BV(COM1A1);}
#define TC3_OUTPUT_COMPARE_SET    {TCCR3A|=_BV(COM1A1)|_BV(COM1A0);}
