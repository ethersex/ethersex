...
/* ATMega2560 specific adjustments */
#define _IVREG MCUCR
#define _EIMSK EIMSK
#define _IVREG MCUCR
...
#define TC1_INT_COMPARE_TST  (TIFR1&_BV(OCF1A))
#define TC1_INT_COMPARE_CLR  TIFR1=_BV(OCF1A);
...
#define TC3_INT_COMPARE_TST  (TIFR3&_BV(OCF3A))
#define TC3_INT_COMPARE_CLR  TIFR3=_BV(OCF3A);
...
#define TIMER_8_AS_1_INT_COMPARE_TST   TC2_INT_COMPARE_TST
#define TIMER_8_AS_1_INT_COMPARE_CLRF  TC2_INT_COMPARE_CLR
