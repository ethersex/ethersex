...
#define TC0_OUTPUT_COMPARE_NONE   {TCCR0A&=~(_BV(COM0B1)|_BV(COM0B0));}
#define TC0_OUTPUT_COMPARE_TOGGLE {TCCR0A&=~(_BV(COM0B1));TCCR0A|=_BV(COM0B0);}
#define TC0_OUTPUT_COMPARE_CLEAR  {TCCR0A&=~(_BV(COM0B0));TCCR0A|=_BV(COM0B1);}
#define TC0_OUTPUT_COMPARE_SET    {TCCR0A|=_BV(COM0B1)|_BV(COM0B0);}

#define TC0_COUNTER_CURRENT  TCNT0
#define TC0_COUNTER_COMPARE  OCR0B

#define TC0_INT_COMPARE_ON   TIMSK0|=_BV(OCIE0);
#define TC0_INT_COMPARE_OFF  TIMSK0&=~_BV(OCIE0);
...
#define TC2_OUTPUT_COMPARE_NONE   {TCCR2A&=~(_BV(COM2B1)|_BV(COM2B0));}
#define TC2_OUTPUT_COMPARE_TOGGLE {TCCR2A&=~(_BV(COM2B1));TCCR2A|=_BV(COM2B0);}
#define TC2_OUTPUT_COMPARE_CLEAR  {TCCR2A&=~(_BV(COM2B0));TCCR2A|=_BV(COM2B1);}
#define TC2_OUTPUT_COMPARE_SET    {TCCR2A|=_BV(COM2B1)|_BV(COM2B0);}

#define TC2_COUNTER_CURRENT  TCNT2
#define TC2_COUNTER_COMPARE  OCR2B

#define TC2_INT_COMPARE_ON   TIMSK2|=_BV(OCIE2B);
#define TC2_INT_COMPARE_OFF  TIMSK2&=~_BV(OCIE2B);
#define TC2_INT_OVERFLOW_ON  TIMSK2|=_BV(TOIE2B);
#define TC2_INT_OVERFLOW_OFF TIMSK2&=~_BV(TOIE2B);
