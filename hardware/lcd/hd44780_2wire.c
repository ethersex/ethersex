...
hd44780_clock_rw(uint8_t read, uint8_t en)
{
  ...
  PIN_SET(HD44780_2WIRE_D);
  LCD_DELAY();                  // ensure 450ns high level
...
{
  /* TODO Don't know what this function is used for so it does nothing ATM.
   * Needs to be fixed from someone with more insight ;-)
   */
  /*
   * FIXME 2016-12-01 Please file a bug if you need this module!
   */
